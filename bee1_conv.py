...
def do_training():
    model = create_model()
    model.fit(training_X, training_Y, n_epoch=30, batch_size=10, shuffle=True, validation_set=(testing_X, testing_Y), show_metric=True, run_id="{}_training".format(name))
