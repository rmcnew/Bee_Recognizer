...
def create_model():
    ...
    net = fully_connected(net, 1800, activation='relu')
    net = fully_connected(net, 1400, activation='relu')
    net = fully_connected(net, 1200, activation='relu')
    net = fully_connected(net, 1100, activation='relu')
    net = fully_connected(net, 150, activation='relu')
